...
assert new File(basedir, "/target/generated-sources/meta-maven-plugin/io/github/rmichela/test_case_multiple_invocations_maven_plugin/HelloAbstractMetaPluginMojo.java")
...
assert new File(basedir, "/target/generated-sources/meta-maven-plugin/io/github/rmichela/test_case_multiple_invocations_maven_plugin/GoodbyeAbstractMetaPluginMojo.java")
